package com.nibras.saas.security;

import com.nibras.saas.exception.UnauthorizedException;
import com.nibras.saas.properties.JwtProperties;
...
public class JwtTokenService {
    ...
    public String generateAccessToken(@Nonnull final String tenantId, @Nonnull final String userId, final String role) {
        ...
        return Jwts.builder()
                ...
                .signWith(this.privateKey, RS256)
                .compact();
    }
    ...
    private static PrivateKey loadPrivateKey(final String privateKeyPath) throws Exception {
    ...
    private static PublicKey loadPublicKey(final String publicKeyPath) throws Exception {
